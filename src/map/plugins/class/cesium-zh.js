// (function () {
/**
 * cesium 控件部分的中文汉化 by  MarsGIS 2019
 * 
 * 原理：当前js方式的汉化方式非从源码层面进行，而是外挂了一个插件执行，使用方便，
 *      但是汉化程度不深，只汉化了cesium可见的控件部分。
 * 
 * 说明：中文通过网络翻译实现,不保证准确性，可以自行修改。 
 */
export function loadCesiumZH() {
    //工具条汉化
    loadToolbar();
    //全屏汉化
    loadFullExtent();
...
// mars3d.loadCesiumZH = loadCesiumZH//挂载到主库上
...
function getChineseMaps() {
    return {
        ...
        "Other": "其他",
        "Terrain": "地形服务",
        "Bing Maps Aerial": "微软影像地图",
        "Bing Maps Aerial with Labels": "微软影像地图（带标注）",
        "Bing Maps Roads": "微软电子地图",
        "Sentinel-2": "Sentinel2影像",
        "Blue Marble": "蓝色弹珠",
        "Earth at night": "地球之夜",
